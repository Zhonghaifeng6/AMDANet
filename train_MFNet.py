...
parser.add_argument('--seed', default=1234, type=int, help='set seed everything')
# Dataset Config
...
parser.add_argument('--nepochs', default=350, type=int, help='loop forever, stop manually')
parser.add_argument('--warm_up_epoch', default=50, type=int, help='')
    ...
    for epoch in range(engine.state.epoch, args.nepochs+1):
        ...
        if (epoch >= args.checkpoint_start_epoch) and (epoch % args.checkpoint_step == 0) or (epoch == args.nepochs):
            ...
            for idx in pbar:
                ...
                print("Label shape:", label.squeeze().cpu().numpy().shape)
