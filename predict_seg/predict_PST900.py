...
from models.model import AMDANet
...
def get_class_colors():
    pattale = [
        [0, 0, 0],  # Background  0
        [228, 228, 179],  # Hand-Drill 1
        [133, 57, 181],  # BackPack 2
        [177, 162, 67],  # Fire-Extinguisher 3
        [50, 178, 200],  # Survivor 4
    ]
    return pattale
...
if __name__ == "__main__":
    ...
    parser.add_argument('-e', '--epochs', default='273', type=str)
    parser.add_argument('-d', '--devices', default='0,1,2', type=str)
    ...
    # Val Config
    parser.add_argument('--eval_crop_size', default=[720,1280], type=list, help='')
    ...
    network = AMDANet(cfg=args, criterion=None, norm_layer=nn.BatchNorm2d)
