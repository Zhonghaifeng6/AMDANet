...
parser.add_argument('--seed', default=3407, type=int, help='set seed everything')
# Dataset Config
        ...
        if (epoch >= args.checkpoint_start_epoch) and (epoch % args.checkpoint_step == 0) or (epoch == args.nepochs):
            ...
            for idx in pbar:
                ...
                with torch.no_grad():
                    ...
                    print(score.shape,"1111111111111111")
                    print(label.shape, "222222222222222")
                    ...
                    print(processed_pred.shape, "33333333333333")
