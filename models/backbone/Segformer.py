...
from models.modules import Local_Eliminating,Global_Eliminating
from timm.models.layers import DropPath, to_2tuple, trunc_normal_
from engine.logger import get_logger
from models.modules import SemanticConsistencyInference
...
class RGBXTransformer(nn.Module):
    def __init__(self, img_size=224, patch_size=16, in_chans=3, num_classes=1000, embed_dims=[64, 128, 256, 512], 
        ...
        self.sci_1 = SemanticConsistencyInference(input_dim=64)
        self.sci_2 = SemanticConsistencyInference(input_dim=128)
        self.sci_3 = SemanticConsistencyInference(input_dim=320)
        self.sci_4 = SemanticConsistencyInference(input_dim=512)
        ...
        self.GEs = nn.ModuleList([Global_Eliminating(dim=embed_dims[0], num_heads=num_heads[0],  qkv_bias=qkv_bias, qk_scale=qk_scale, attn_drop=attn_drop_rate, proj_drop=drop_rate,sr_ratio=sr_ratios[0]),
                                  Global_Eliminating(dim=embed_dims[1],  num_heads=num_heads[1], qkv_bias=qkv_bias, qk_scale=qk_scale, attn_drop=attn_drop_rate, proj_drop=drop_rate,sr_ratio=sr_ratios[1]),
                                  Global_Eliminating(dim=embed_dims[2],  num_heads=num_heads[2], qkv_bias=qkv_bias, qk_scale=qk_scale, attn_drop=attn_drop_rate, proj_drop=drop_rate,sr_ratio=sr_ratios[2]),
                                  Global_Eliminating(dim=embed_dims[3],  num_heads=num_heads[3], qkv_bias=qkv_bias, qk_scale=qk_scale, attn_drop=attn_drop_rate, proj_drop=drop_rate,sr_ratio=sr_ratios[3])])
