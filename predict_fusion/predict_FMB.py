...
if __name__ == "__main__":
    ...
    parser.add_argument('-e', '--epochs', default='117', type=str)
    ...
    parser.add_argument('--class_names',
                        default=['background', 'Road', 'Sidewalk', 'Building', 'Lamp', 'Sign', 'Vegetation', 'Sky',
    ...
    # Val Config
    parser.add_argument('--eval_crop_size', default=[600, 800], type=list, help='')
